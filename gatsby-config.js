module.exports = {
  siteMetadata: {
    title: `Power Mind Club`, author: {
      name: "Power Mind Club"
    }, description: "Empower your relationship", siteUrl: `https://www.powermindclub.com`, menuLinks: [{
      name: "Home", link: "/"
    }, {
    ...
    "gatsby-plugin-image", "gatsby-plugin-offline", "gatsby-plugin-react-helmet", "gatsby-plugin-sharp", "gatsby-plugin-layout", {
      ...
      resolve: `gatsby-plugin-google-gtag`, options: {
        ...
        gtagConfig: {
          ...
          anonymize_ip: true, cookie_expires: 0
      ...
      resolve: `gatsby-plugin-sass`, options: {
        postCssPlugins: [require("tailwindcss"), require("./tailwind.config.js") // Optional: Load custom Tailwind CSS configuration
        ]
      }
    }, {
