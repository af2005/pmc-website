        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                 className="inline-block w-8 h-8 text-ming mb-8" viewBox="0 0 975.036 975.036">
              <path
            ...
            <p className="leading-relaxed text-lg">Dank Power Mind Club ist so vieles leichter und harmonischer! Unsere Beziehung hat eine ganz andere
              Qualität erreicht und es kommt kaum noch zu Missverständnissen und Konflikten. Und das, obwohl wir oft
              kurz vorm Ende standen. Wir sind unglaublich dankbar für unseren Power Mind Coach.</p>
