    ...
    return (<>
        <div className="py-10 md:py-20  bg-gray-50">
            <div className="container m-auto pb-10 md:pb-20">
                <img src={teamcollab} alt="spread love" className="h-56 px-10 m-auto"/>
            </div>

            <div className="container mx-auto px-6 md:px-12">
                <div className="mb-16">
                    <h2 className="mb-4 text-center text-2xl text-gray-900 font-bold md:text-4xl">Die Power Minds
                    </h2>
                    <p className="text-gray-600 lg:w-8/12 lg:mx-auto">
                        We are a strong and diverse team with expertise in strategy consulting, business
                        development, counseling, coding, and digital solution.</p>
                </div>
                <div className="grid gap-24 md:gap-12 md:grid-cols-3">
                    <div className="space-y-4 text-center group">
                        <div
                            className="w-56 h-56 mx-auto rounded-[4rem] rotate-45 overflow-hidden md:w-40 md:h-40 lg:w-56 lg:h-56">
                            <img
                                className="w-full h-full object-cover -rotate-45 scale-125 mx-auto transition duration-300 group-hover:scale-[1.4]"
                                src={chenchen} alt="woman" loading="lazy" width="640" height="805"/>
                        </div>
                        <div className="pt-4">
                        ...
                        <div className="flex justify-center space-x-4 text-gray-500">
                            <a href="#" target="_blank" aria-label="facebook">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 hover:text-blue-600"
                    ...
                    <div className="space-y-4 text-center group">
                        <div
                            ...
                            <img
                                className="w-full h-full object-cover -rotate-45 scale-125 mx-auto transition duration-300 group-hover:scale-[1.4]"
                                src={kim} alt="man" loading="lazy" width="1000" height="667"/>
                        </div>
                        <div className="pt-4">
                            <h4 className="pmc-h1 text-xl">Kim Kasch</h4>
                            <span className="block text-sm text-gray-500">CFO & Founder</span>
                        </div>
                        <div className="flex justify-center space-x-4 text-gray-500">
                            <a href="#" target="_blank" aria-label="facebook">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 hover:text-blue-600"
                    ...
                    <div className="space-y-4 text-center group">
                        <div
                            ...
                            <img
                                className="w-full h-full object-cover -rotate-45 scale-125 mx-auto transition duration-300 group-hover:scale-[1.4]"
                                src={alex} alt="woman" loading="lazy" width="640" height="805"/>
                        </div>
                        <div className="pt-4">
