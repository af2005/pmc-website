      ...
      <div className="flex flex-col mb-12 overflow-hidden">
        ...
        <div className="flex flex-col justify-between flex-1">
          <div className="flex-1">
            ...
            <Link
              to="/blog/entries/2022-06-21-kraft-der-rituale"
      ...
      <div className="py-16 bg-gradient-to-br from-green-50 to-cyan-100">
        <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
          <div className="mb-12 space-y-2 text-center">
            ...
            <p className="lg:w-6/12 lg:mx-auto">Willkommen in unserem Blog.</p>
          </div>
        </div>
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="grid max-w-lg gap-12 mx-auto mt-12 px-6">
              ...
              <BlogEntryTeaser
                image={kitchen}
                title={
                  "Die Kraft der Rituale – 5 Empfehlungen, die eure Beziehung stärken"
                }
              >
                Geht es euch auch so? Die Welt dreht sich gefühlt immer
                schneller, die Komplexität nimmt weiter zu und man weiß gar
                nicht mehr, wie man all die Termine unter einen Hut bringen
                soll?
              </BlogEntryTeaser>
            </div>
          </div>
